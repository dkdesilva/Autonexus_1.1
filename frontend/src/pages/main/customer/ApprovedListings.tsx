...
const ApprovedListings: React.FC<Props> = ({ vehicleListings, animationProps }) => {
  const approvedListings = vehicleListings.filter(listing => listing.approval_status === 'Approved');

  return (
    <motion.div key="approved" {...animationProps}>
