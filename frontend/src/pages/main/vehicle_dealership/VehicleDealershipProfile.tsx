...
import DealershipProfileFormSection from '../../../components/landing/sections/vehicle_dealership/DealershipProfileFormSection';
import DealershipProfileHeaderSection from '../../../components/landing/sections/vehicle_dealership/DealershipProfileHeaderSection';
  ...
  return (
    <div className="min-h-screen overflow-y-auto bg-gray-50 dark:bg-gray-900">
      ...
      <div className="space-y-8 sm:px-8 md:px-12 lg:px-24 pb-16 pt-20">
        ...
        <DealershipProfileHeaderSection/>
        {/* Tabs Section */}
