...
import CustomerProfileImageSection from './SparepartProfileImageSection';
...
const SparepartProfileHeaderSection: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchUserProfile = async () => {
      try {
        ...
        const res = await fetch('http://localhost:5000/api/spareparts/details', {
          headers: {
...
export default SparepartProfileHeaderSection;
